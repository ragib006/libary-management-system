...
@section('change')
  ...
  <div class="content" style="overflow:hidden;margin:20px 20px">
   ...
   <h3 style="margin-bottom: 20px">All  Pending Libary Book</h3>
...
@foreach($allpedingbooklist as $v_show)
  ...
  <tr>
    ...
    <td>{{$v_show->take_book_stu_bookname}}</td>
      ...
      <a href="{{URL::to('/return_book/'.$v_show->take_id)}}"><Button>Return book</Button></a>
